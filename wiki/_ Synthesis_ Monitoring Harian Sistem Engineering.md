...
```plain text
Deviasi terdeteksi (parameter di luar batas / alarm aktif)
    ↓
Catat waktu dan nilai deviasi
    ↓
Coba identifikasi penyebab (30 detik - 2 menit)
    ↓
Lapor ke Supervisor segera (jangan tunda)
    ↓
Supervisor memutuskan: monitor lanjut / shutdown / eskalasi ke Manager
    ↓
Dokumentasikan di formulir yang relevan
```
