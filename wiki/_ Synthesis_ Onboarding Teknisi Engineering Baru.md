...
- [ ] Pahami struktur org Engineering dan ke siapa melapor
- [ ] Kenali area yang dilayani (produksi, QA, warehouse, CUB)
- [ ] Baca SOP sistem yang akan dikerjakan (HVAC / udara tekan / listrik / mesin)
- [ ] Pahami 4 jenis perawatan
- [ ] Praktik prosedur PJE bersama Supervisor
- [ ] Kenali lokasi panel listrik utama (MDP) dan cara isolasinya
- [ ] Pahami prosedur emergency shutdown sistem yang relevan
- [ ] Kenali Part Code dan cara mengakses Database Inventory